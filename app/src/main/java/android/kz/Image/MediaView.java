...
import myAi.Knowanything.windows.R;
...
public class MediaView extends ViewGroup implements View.OnClickListener {
    ...
    public MediaView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode())
      initAttributes(attrs,defStyle,ImageLoader.getInstance());
		
    }

    private void initAttributes(AttributeSet attrs, int defStyle, ImageLoader loader) {
        ...
        try {
            ...
            photoErrorResId = a.getResourceId(R.styleable.MediaView_place_holder, R.mipmap.ic_launcher);
